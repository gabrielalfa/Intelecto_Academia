...
var handleFormMaskedInput = function() {
    ...
    $("#masked-input-phone").mask("(99) 9999-9999");
    $("#masked-input-phone_2").mask("(99) 9999-9999");
    $("#masked-input-phone_3").mask("(99) 9999-9999");
    ...
    $("#masked-input-RG").mask("9999999999");
    $("#masked-input-CEP").mask("99999-999");
};
